...
const SPECS: TemplateSpec[] = [
  {
    ...
    placements: [
      ...
      ["token-variable-usage", 0.72, 0.28],
      ["adopter-satisfaction", 0.25, 0.3],
      ["deprecated-component-usage", 0.75, 0.78],
      ["contribution-rules-met", 0.7, 0.72],
      ["system-trust", 0.28, 0.7],
    ],
  },
  {
    id: "salud-sistema",
    ...
    accentColor: "#0891b2",
    placements: [
      ["open-issues-per-component", 0.78, 0.2],
      ["components-without-owner", 0.75, 0.28],
      ["component-health-score", 0.3, 0.25],
      ["design-code-parity", 0.32, 0.32],
      ["orphan-variants", 0.72, 0.78],
      ["time-since-last-update", 0.3, 0.8],
    ],
  },
  {
    id: "impacto-delivery",
    ...
    placements: [
      ...
      ["time-to-handoff", 0.75, 0.28],
      ["rework-reduction", 0.3, 0.25],
      ["perceived-speed", 0.28, 0.35],
      ["reuse-rate", 0.75, 0.72],
      ["system-releases", 0.3, 0.78],
    ],
  },
  {
    id: "figma-codigo",
    ...
    placements: [
      ...
      ["screens-with-active-libraries", 0.22, 0.3],
      ["npm-package-usage", 0.8, 0.25],
      ["token-consistency", 0.3, 0.75],
      ["design-code-parity", 0.7, 0.72],
      ["test-coverage", 0.8, 0.78],
    ],
  },
  {
    id: "ia-anti-slop",
    ...
    accentColor: "#0d99ff",
    placements: [
      ["reused-prompts", 0.25, 0.2],
      ["generative-consistency", 0.75, 0.25],
      ["validated-templates", 0.78, 0.3],
      ["visual-slop-ratio", 0.28, 0.75],
      ["guardrails-coverage", 0.72, 0.72],
      ["post-ai-correction-ratio", 0.75, 0.8],
    ],
  },
  {
    id: "valor-facilidad",
    ...
    placements: [
      ...
      ["time-to-market", 0.7, 0.3],
      ["system-trust", 0.25, 0.25],
      ["system-accessibility", 0.3, 0.32],
      ["documentation-visits", 0.8, 0.75],
    ],
  },
  {
    id: "por-audiencia",
    ...
    placements: [
      ["time-to-market", 0.8, 0.2],
      ["reuse-rate", 0.75, 0.28],
      ["component-usage", 0.25, 0.25],
      ["docs-coverage", 0.3, 0.3],
      ["component-health-score", 0.75, 0.75],
      ["support-tickets", 0.25, 0.8],
    ],
  },
  {
    id: "madurez-sistema",
    ...
    placements: [
      ["component-usage", 0.8, 0.2],
      ["npm-package-usage", 0.75, 0.28],
      ["documentation-coverage", 0.25, 0.25],
      ["test-coverage", 0.3, 0.32],
      ["deprecated-component-usage", 0.75, 0.75],
      ["visual-slop-ratio", 0.25, 0.8],
    ],
  },
];
